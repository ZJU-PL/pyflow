...
```bash
python -m a3_python.cli tests/synthetic_suite/DEADLOCK/tp_01_circular_lock_acquisition.py
python -m a3_python.cli tests/synthetic_suite/DEADLOCK/tn_01_consistent_lock_ordering.py
```
