...
```bash
python -m a3_python.cli tests/synthetic_suite/INTEGER_OVERFLOW/tp_01_ctypes_overflow.py
python -m a3_python.cli tests/synthetic_suite/INTEGER_OVERFLOW/tn_01_pure_python_arithmetic.py
```
