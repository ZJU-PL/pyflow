...
async def view_page(page_id):
    ...
    # Vulnerable function - renders raw HTML content without proper sanitization
    def render_documentation_page(page):
        return f"""
        <!DOCTYPE html>
        <html>
        <head>
    ...
    return render_documentation_page(documentation_pages[page_id])
