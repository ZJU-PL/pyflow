...
This module tests the DDG construction from dataflow IR, including:
- Basic DDG construction from dataflow IR
...
from pyflow.ir.ddg.graph import DataDependenceGraph, DDGNode, DDGEdge
...
class TestDDG(unittest.TestCase):
    ...
    def build_dataflow(self, func):
        """Build dataflow IR from a function."""
