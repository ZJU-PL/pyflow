"""Tests for analysis/dataflowIR/ordering.py - Dataflow Ordering."""

import unittest
from unittest.mock import MagicMock, patch

from pyflow.analysis.dataflowIR.ordering import OrderSearcher, evaluateDataflow
...
class TestEvaluateDataflow(unittest.TestCase):
    ...
    @patch("pyflow.analysis.dataflowIR.ordering.OrderSearcher")
