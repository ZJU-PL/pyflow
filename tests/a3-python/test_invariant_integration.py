...
import pytest
from pyflow.a3_python.semantics.invariant_integration import (
    InvariantIntegrator,
    LoopInvariantResult,
    add_invariant_synthesis_to_state
)
from pyflow.a3_python.semantics.symbolic_vm import SymbolicVM, SymbolicMachineState
from pyflow.a3_python.cfg.loop_analysis import extract_loops
...
""", "<test>", "exec")
        ...
        from pyflow.a3_python.z3model.heap import SymbolicHeap
        from pyflow.a3_python.semantics.security_tracker_lattice import LatticeSecurityTracker
        import z3
...
class TestEndToEndIntegration:
    ...
    def test_cli_flag_integration(self):
        ...
        from pyflow.a3_python.analyzer import analyze
