...
from pyflow.a3_python.barriers.invariants import (
    InductivenessResult,
    InductivenessChecker,
)
from pyflow.a3_python.barriers.templates import quadratic_barrier
...
def test_counterexample_summary_formatting():
    ...
    from pyflow.a3_python.barriers.cegis import CEGISResult
