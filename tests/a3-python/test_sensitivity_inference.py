...
from pyflow.a3_python.semantics.security_tracker_lattice import infer_sensitivity_from_name
from pyflow.a3_python.z3model.taint_lattice import SourceType, TaintLabel
