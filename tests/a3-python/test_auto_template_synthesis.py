...
from pyflow.a3_python.barriers.cegis import (
    synthesize_barrier_with_auto_template,
    CEGISConfig,
)
from pyflow.a3_python.barriers.program_analysis import (
...
class TestLinearTemplateCEGIS:
    ...
    def test_linear_template_parameters_created(self):
        ...
        from pyflow.a3_python.barriers.cegis import CEGISBarrierSynthesizer
