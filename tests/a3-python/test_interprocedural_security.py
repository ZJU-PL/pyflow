...
'''
    ...
    def test_source_function_summary(self):
        ...
        from pyflow.a3_python.cfg.call_graph import build_call_graph_from_file
        from pyflow.a3_python.semantics.summaries import SummaryComputer
        from pyflow.a3_python.contracts.security_lattice import SourceContract, SourceType
...
'''
    ...
    def test_sink_function_summary(self):
        ...
        from pyflow.a3_python.cfg.call_graph import build_call_graph_from_file
        from pyflow.a3_python.semantics.summaries import SummaryComputer
        from pyflow.a3_python.contracts.security_lattice import SinkContract, SinkType
