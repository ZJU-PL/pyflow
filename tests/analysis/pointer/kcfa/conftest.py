...
from pyflow.analysis.pointer._pythonstan.analysis.pointer.kcfa.object import ModuleObject
from pyflow.analysis.pointer._pythonstan.ir.ir_statements import IRAssign, IRModule, IRAstStmt
