...
import pytest
from pyflow.analysis.pointer._pythonstan.analysis.pointer.kcfa import (
    Field,
    FieldKind,
)
from pyflow.analysis.pointer._pythonstan.analysis.pointer.kcfa.heap_model import attr, elem, value, unknown
...
class TestFieldInConstraints:
    ...
    def test_load_constraint_field(self, variable_factory):
        ...
        from pyflow.analysis.pointer._pythonstan.analysis.pointer.kcfa import LoadConstraint
    ...
    def test_store_constraint_field(self, variable_factory):
        ...
        from pyflow.analysis.pointer._pythonstan.analysis.pointer.kcfa import StoreConstraint
