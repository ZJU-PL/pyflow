...
@pytest.fixture
def mock_module():
    from pyflow.analysis.alias.kcfa._pythonstan.ir.ir_statements import IRModule
    return IRModule("test_module")

@pytest.fixture
def abstract_state():
    from pyflow.analysis.alias.kcfa._pythonstan.analysis.ai import AbstractState, ContextType, FlowSensitivity
    return AbstractState(ContextType.CALL_SITE, FlowSensitivity.SENSITIVE)

@pytest.fixture
def abstract_interpreter(abstract_state):
    from pyflow.analysis.alias.kcfa._pythonstan.analysis.ai import AbstractInterpreter
    return AbstractInterpreter(abstract_state)

@pytest.fixture
def abstract_solver():
    from pyflow.analysis.alias.kcfa._pythonstan.analysis.ai import create_solver, ContextType, FlowSensitivity
...
def make_pointer_results():
    ...
    from pyflow.analysis.alias.kcfa._pythonstan.analysis.ai.pointer_adapter import MockPointerResults
...
def mock_call_sites():
    ...
    from pyflow.analysis.alias.kcfa._pythonstan.analysis.ai.pointer_adapter import MockCallSite
...
def mock_abstract_objects():
    ...
    from pyflow.analysis.alias.kcfa._pythonstan.analysis.ai.pointer_adapter import MockAbstractObject
...
def field_keys():
    ...
    from pyflow.analysis.alias.kcfa._pythonstan.analysis.ai.pointer_adapter import (
...
def mock_contexts():
    ...
    from pyflow.analysis.alias.kcfa._pythonstan.analysis.ai.pointer_adapter import MockContext, MockCallSite
