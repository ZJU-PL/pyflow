...
from pyflow.analysis.fsdf import canonicalset, canonicaltree
...
class TestCanonicalSet(unittest.TestCase):
    ...
    def testUnion(self):
        ...
        self.assertTrue(self.manager.union(a, b) is c)
    ...
    def testIntersection(self):
        ...
        self.assertTrue(self.manager.intersection(a, b) is c)
...
class TestCanonicalTree(unittest.TestCase):
    ...
    def testAnd(self):
        ...
        result = self.manager.and_(a, b)
        self.assertTrue(result is c, (result, c))
    ...
    def testITE2(self):
        ...
        c = self.manager.tree(
            self.c1,
            (self.manager.tree(self.c0, (t, f)), self.manager.tree(self.c0, (f, t))),
        )
...
class TestCanonicalSetTree(unittest.TestCase):
    ...
    def testSimplify(self):
        ...
        self.assertTrue(result is expected, (result, expected))
