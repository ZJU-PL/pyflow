...
The ``pyflow.ir.cfg`` package constructs and represents control flow graphs
from Python AST nodes. It also provides the graph algorithms and
transformations used by analyses and optimization passes.
