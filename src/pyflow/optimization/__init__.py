...
Optimization Categories:
    ...
    - Code Inlining (codeinlining.py): Experimental function body substitution
...
Optimization Pipeline:
    ...
    3. Advanced Phase: Method optimization and cloning
    4. Finalization Phase: lifetime refresh, load/store elimination, program culling
