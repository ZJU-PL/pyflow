...
DEFAULT_HEAP_INTRINSICS = HeapIntrinsicModels(
    return_kinds={
        ...
        "memoryview": CALL_RETURN_FRESH,
        "builtins.memoryview": CALL_RETURN_FRESH,
        ...
        "functools.cached_property": CALL_RETURN_FRESH,
        "functools.reduce": CALL_RETURN_FRESH,
        "functools.singledispatch": CALL_RETURN_FRESH,
        "functools.wraps": CALL_RETURN_FRESH,
        # ── itertools ──────────────────────────────────────────────────
        ...
        "itertools.combinations_with_replacement": CALL_RETURN_FRESH,
        ...
        "itertools.pairwise": CALL_RETURN_FRESH,
        "itertools.batched": CALL_RETURN_FRESH,
        "itertools.tee": CALL_RETURN_FRESH,
        ...
        # ── logging ────────────────────────────────────────────────────
        "logging.getLogger": CALL_RETURN_FRESH,
        ...
        "decimal.getcontext": CALL_RETURN_FRESH,
        ...
        # ── importlib ──────────────────────────────────────────────────
        "importlib.import_module": CALL_RETURN_FRESH,
        # ── operator ───────────────────────────────────────────────────
