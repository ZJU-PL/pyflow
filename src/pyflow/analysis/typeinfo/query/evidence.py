...
def collect_python_type_info(source: str, *, filename: str | None = None) -> TypeEvidenceIndex:
...
def collect_pyflow_type_info(codes: Iterable[object]) -> TypeEvidenceIndex:
