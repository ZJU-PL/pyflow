...
from pyflow.language.python import simplecodegen, ast
import io
...
class Dumper(object):
    ...
    def invokesIn(self, context, o):
        ...
        for src, invokes in grouped.items():
            with o.scope("p"):
    ...
    def invokesOut(self, context, o):
        ...
        for op, invokes in grouped.items():
            with o.scope("p"):
                o << op
                o.tag("br")
                for invoke in invokes:
    ...
    def locals(self, context, o):
        ...
        for slot in context.locals.values():
            with o.scope("p"):
    ...
    def index(self, contexts, root):
        def forward(context):
            return set([invoke.dst for invoke in context.invokeOut.values()])
