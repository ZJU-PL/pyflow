...
(`pythonstan.X` -> `pyflow.analysis.pointer._pythonstan.X`) are **not** listed
...
## 1. `analysis/pointer/kcfa/state.py`  [ENHANCEMENT] [BEHAVIOR]
...
## 2. `analysis/pointer/kcfa/solver.py`  [BUGFIX] [REFACTOR] [BEHAVIOR]
...
## 3. `analysis/pointer/kcfa/analysis.py`  [REFACTOR]
...
## 4. `analysis/pointer/kcfa/ir_translator.py`  [ENHANCEMENT] [BEHAVIOR]
...
## 5. `analysis/pointer/kcfa/constraints.py`  [BEHAVIOR]
...
## 6. `analysis/pointer/kcfa/builtin_api_handler.py`  [ENHANCEMENT]
...
## 7. `analysis/pointer/kcfa/class_hierarchy.py`  [BUGFIX]
...
## 8. `analysis/pointer/kcfa/heap_model.py`  [COMPAT] [BEHAVIOR]
...
## 9. `analysis/pointer/kcfa/object.py`  [ENHANCEMENT]
...
## 10. `analysis/pointer/kcfa/module_analysis.py`  [REFACTOR]
...
## 11. `analysis/pointer/kcfa/module_summary.py`  [COMPAT]
...
## 12. `analysis/pointer/kcfa/processor/processor.py`  [COMPAT]
...
`analysis/pointer/ai/`). The migration replaces the broken import with an
...
## 17. `analysis/pointer/kcfa/debug_monitor.py`  [NEW]
...
## 19. `analysis/pointer/kcfa/libs/__init__.py`  [NEW]
