...
from pyflow.analysis.pointer._pythonstan.analysis.pointer.kcfa.analysis import (
    AnalysisResult,
)
...
if TYPE_CHECKING:
    ...
    from pyflow.analysis.pointer._pythonstan.analysis.pointer.kcfa.points_to_set import (
        PointsToSet,
    )
