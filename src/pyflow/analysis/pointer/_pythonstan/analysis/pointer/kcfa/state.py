...
from pyflow.analysis.pointer._pythonstan.utils.common import Box
from pyflow.analysis.pointer._pythonstan.ir.ir_statements import IRModule, IRStatement
from pyflow.analysis.pointer._pythonstan.graph.call_graph import AbstractCallGraph, CallEdge
from .object import *
...
if TYPE_CHECKING:
    from pyflow.analysis.pointer._pythonstan.world.scope_manager import ScopeManager
        ...
        if not exists:
            ...
            if isinstance(obj, SuperObject):
                ...
                if obj.current_class:
                    ...
                    from pyflow.analysis.pointer._pythonstan.ir.ir_statements import IRClass
