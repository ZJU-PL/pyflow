...
from pyflow.analysis.pointer._pythonstan.graph.call_graph import CallEdge, CallKind
from pyflow.analysis.pointer._pythonstan.ir.ir_statements import IRFunc, IRAssign
