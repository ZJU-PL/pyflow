    ...
    **Command-Line Arguments:**
    ...
    def __call__(self, *args, **kwargs):
        ...
        parser = argparse.ArgumentParser(
            description="Coverage-guided fuzzer for python packages"
        )
        parser.add_argument(
            "dirs",
            type=str,
        ...
        parser.add_argument(
            "--rss-limit-mb", type=int, default=2048, help="Memory usage in MB"
        )
        parser.add_argument(
            "--max-input-size", type=int, default=4096, help="Max input size in bytes"
        )
