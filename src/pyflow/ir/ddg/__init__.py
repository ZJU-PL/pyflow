...
existing dataflow IR and SSA infrastructure. A Data Dependence Graph
...
**Construction:**
The DDG is built from dataflow IR graphs by:
...
- construction.py: Algorithms for building DDG from dataflow IR
