"""
Comprehensive semantic taint detector backed by PyFlow analyses.
...
class _LocalSemanticTaintAnalyzer(ast.NodeVisitor):
    """Flow-sensitive intra-procedural taint tracking for semantic taint analysis."""
